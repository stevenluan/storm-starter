 ...
 * 
 */
public class RollingCountOfCollectionBolt extends BaseRichBolt {

    private static final long serialVersionUID = 5537727428628598519L;
    private static final Logger LOG = Logger.getLogger(RollingCountOfCollectionBolt.class);
    ...
    public RollingCountOfCollectionBolt() {
        this(DEFAULT_SLIDING_WINDOW_IN_SECONDS, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
    }

    public RollingCountOfCollectionBolt(int windowLengthInSeconds, int emitFrequencyInSeconds) {
